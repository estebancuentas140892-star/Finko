...
> Última actualización: 2026-07-15 (MC.13e-2a cerrada → la tarjeta "Distribuir mi ingreso" pierde los accesos cruzados, separa el aviso "recibiste tu ingreso" y modernizan los botones del asistente. Primera de las 7 rebanadas de MC.13e-2 (análisis del rediseño del asistente, [ADR 041](DECISIONS/041-motor-vencimientos-y-distribucion-v2.md)); siguen MC.13e-2b a MC.13e-2g).
