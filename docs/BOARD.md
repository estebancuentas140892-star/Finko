...
> Última actualización: 2026-07-13 (CAT.2f: selector de ícono en Gasto fijo/Calendario, sexto y último consumidor, cierra la iniciativa CAT.2 completa).

---

## En proceso

_(Sin tarjeta activa: **CAT.2f cerrada** el 2026-07-13 (Gasto fijo/Calendario migrado como sexto y último consumidor del picker compartido, categoría "Otro"; ver Transversal abajo). **Iniciativa CAT.2 completa** (CAT.2a-f, las 6 rebanadas cerradas). Queda **CAT.3** (categorías personalizadas globales, mismo estatus que las nativas en toda la app) y **CAT.1** (taxonomía Gastos↔Fijos, aún sin validar con Esteban) como los siguientes pasos naturales de la iniciativa CAT.)_
