...
> Última actualización: 2026-07-13 (CAT.1a: Gastos ya no ofrece Vivienda/Servicios públicos + hint retirado, primera rebanada de la taxonomía CAT.1).

---

## En proceso

_(Sin tarjeta activa: **CAT.1a cerrada** el 2026-07-13 (Gastos ya no ofrece Vivienda ni Servicios públicos, hint retirado por completo; ver Transversal abajo). Quedan **CAT.1b** (Apartados) y **CAT.1c** (Metas) como siguientes rebanadas de la taxonomía, y después **CAT.3** (categorías personalizadas globales), ya desbloqueada.)_
...
- Rebanadas  : **CAT.1a CERRADA el 2026-07-13** (Gastos: quitó Vivienda y Servicios públicos del form + retiró el hint completo, ver CHANGELOG y [`contexto/transversal.md`](contexto/transversal.md)). Quedan **CAT.1b** Apartados (plantillas: sale Vacaciones, renombra Matrícula escolar y Útiles y uniformes, entran las 4 nuevas con emoji curado; tests) y **CAT.1c** Metas (sale Cumpleaños + fusión Vacaciones/Viajes; render legado seguro vía `CATEGORIA_META_ICONO`; tests). Independientes y verificables por separado.
