...
| DV.2b | Riqueza visual piloto: formas orgánicas + patrón | Transversal | media-alta | nada (DV.2a cerrada) |
...
> **Iniciativa Dirección Visual premium** ([ADR 033](DECISIONS/033-direccion-visual-premium.md), **Aceptada el 2026-07-30** en P1, P2, P3 y P5), evolución de la identidad de color por sección ([ADR 031](DECISIONS/031-identidad-de-color-por-seccion.md), IV.1 e IV.2 cerradas). **DV.2a cierra el 2026-07-31.** Siguen DV.2b y DV.2c, ya desbloqueadas. Solo **P4** (lote inicial de ilustraciones) sigue abierta y se decide al iniciar DV.2d.

#### DV.2b - Riqueza visual piloto: formas orgánicas + patrón (D3 del ADR 033)
- Prioridad  : media-alta
- Área       : design
- Estado     : **desbloqueada** (P2 resuelta el 2026-07-30: catálogo neutro compartido de 3 a 5 formas, teñido por dominio vía `currentColor`; DV.2a cerrada el 2026-07-31). Ejecutable ya.
...
- Depende de : nada (DV.2a cerrada, usa `--fk-section-color`)
...
- Prioridad  : media-alta
- Área       : design
- Estado     : **desbloqueada** (ADR 033 aceptado el 2026-07-30). Ejecutable ya, independiente de DV.2b.
...
- Depende de : ADR 033 aprobado; independiente de DV.2b
