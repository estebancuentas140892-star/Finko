...
> Última actualización: 2026-07-15 (FORM.1c cerrada → Nuevo gasto fijo adopta el lenguaje de Formularios v2, [ADR 042](DECISIONS/042-formularios-v2-visual.md): **iniciativa FORM completa, sin tarjetas pendientes**. Queda abierto TX.11 en Transversal (hallazgo de FORM.1b: la app tiene tres switches para el mismo control). MC.13: sólo falta el asistente v2 UI, MC.13e+, [ADR 041](DECISIONS/041-motor-vencimientos-y-distribucion-v2.md)).
