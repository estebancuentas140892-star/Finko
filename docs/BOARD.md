...
- Rebanadas  : **ANL.2a CERRADA 2026-07-13** (score hero + chip de mes, D1+D6, ver CHANGELOG) → **ANL.2b** patrimonio + ojo (D2) → **ANL.2c** "A dónde va tu dinero" (D3+D4) → **ANL.2d** colapsables + empty state (D5+D7)
- Secciones  : Análisis
