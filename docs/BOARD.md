...
> Última actualización: 2026-07-13 (CAT.1: taxonomía global validada con Esteban; ADR 014 aceptado, ADR 029 D3 confirmada; tarjeta re-cortada en CAT.1a-c).

---

## En proceso

_(Sin tarjeta activa: la **validación de taxonomía de CAT.1 se hizo el 2026-07-13** con Esteban (ADR 014 aceptado, ADR 029 D3 confirmada, sin bump de schema; ver Transversal abajo). El siguiente paso natural es **CAT.1a** (Gastos: quitar Vivienda y Servicios públicos del form + retirar el hint), seguido de CAT.1b (Apartados) y CAT.1c (Metas); después **CAT.3** (categorías personalizadas globales), que ya quedó desbloqueada por la taxonomía.)_
