...
- Estado     : en curso, 2 de 3 rebanadas cerradas (MT.6a, MT.6b). Alcance y las 3 decisiones: **[ADR 048](../DECISIONS/048-metas-v2-subcategorias-y-plan-de-aportes.md)**, su dueño. La estructura de datos que D1 delegaba ya está decidida en el **[ADR 064](../DECISIONS/064-estructura-de-dos-niveles.md)**. **D2 (cuota con la frecuencia real de ingresos) se declaró cumplida sin código**: la entregaron MT.4 y MC.13b.
...
**MT.6c - plan de aportes generado y recalculado** (ADR 048 D3, siguiente)
