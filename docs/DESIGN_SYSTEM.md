...
> Última revisión: 2026-07-27 (R38 a R40, auditoría de diseño de Mis cuentas; el informe numeraba seis reglas, R19 a R24, y solo entran tres: su R20 corresponde a una corrección transversal que quedó fuera de alcance, su R22 ya la dice R20 y su R24 ya la dice R24. R38 y R39 van en Principios, R40 en Chips y Badges junto a R22, de la que es continuación. Antes R36 y R37, auditoría de la Barra de navegación; R34 y R35, auditoría de Límites de gasto, que el informe numeraba R9 y R10 y se renumeraron al primer hueco real. Antes R29 a R33, auditoría de la Interfaz: la capa global de navegación, con salto de R28 a R29 porque la auditoría de Análisis, que reservaba R25 a R29, sigue sin aplicarse; R23 a R28 de la de Apartados, R9 a R11 de la de Gastos, R19 a R22 de la de Me deben, R7 y R8 de la de Deudas, R1 a R6 de la de Inicio, radio protagonista y [ADR 054](DECISIONS/054-el-acento-no-mide-gasto.md)).
