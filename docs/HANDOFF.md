...
> Última actualización: 2026-07-05 (feat(gastos): TX.9b, categorías personalizadas)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 2224/2224 verdes |
| Tests E2E | 149/149 verde. Suites: `smoke` 83 tests, `estrategia-pago` 15 tests, `ahorro-inversion` 9 tests, `hub-ahorros` 7 tests, `navegacion-render` 7 tests, `registrar-destinos` 6 tests, `install-prompt` 6 tests, `a11y-forms` 6 tests, `reflow-320` 4 tests, `registrar-distribucion` 3 tests, `registrar-sheet` 3 tests. |
