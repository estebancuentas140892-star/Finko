...
> Revisado: 2026-08-12. Última tarea cerrada: MT.6c, plan de aportes generado y recalculado (Metas).
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 3973/3973 verdes (17 nuevos de MT.6c: `fechasAportePlan`/`generarPlanAportes` y su migración) |
| Tests E2E | 264/264 verdes, sello escrito sobre el runtime de MT.6c. **Compuerta** desde el 2026-07-30 |
