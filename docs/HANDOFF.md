...
> Última actualización: 2026-07-06 (perf(storage): PERF.4, ADR 030 persistencia: salvaguarda de cuota + diferir rewrite)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 2228/2228 verdes |
