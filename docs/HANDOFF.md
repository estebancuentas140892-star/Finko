...
> Revisado: 2026-08-12. Última tarea cerrada: PE.6d, los cinco estados de Me deben se distinguen de un vistazo (cierra PE.6 completa).
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 3987/3992 verdes (2 nuevos de PE.6d; 5 fallas preexistentes en `compromisos.test.js`, ajenas a PE.6d, patrón de reloj fijo ya anotado en BUGS.md) |
