...
> Revisado: 2026-08-21. Última tarea cerrada: ficha 10 de MOV.1, Reservas usa el orden que ya tenía (ADR 083).
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 4504/4510 (2026-08-21). Los 6 rojos son **BUG-028**, ajeno |
| Tests E2E | 298/298 verdes, sello de la ficha 10 (2026-08-21). **Compuerta** desde el 2026-07-30 |
...
Sexta de las 25 entregas, con [ADR 080](DECISIONS/080-mis-cuentas-un-primario-y-lo-informativo-al-pie.md), que **acota el ADR 075** en D1 y D5. Las nueve puertas resuelven en negativo el disparador de la ficha 03: no entra a la barra. Lo de solo lectura baja al pie, queda un solo primario con dos atajos declarados de Registrar (R87) y la tarjeta de credito sale a Por pagar prefiltrada. SW v572.
...
- **En proceso:** **auditoría UX/UI móvil de Claude Design, 25 entregas**. Cerradas 01 a 10 (ADR [069](DECISIONS/069-bloque-gastos-en-la-barra-movil.md), [080](DECISIONS/080-mis-cuentas-un-primario-y-lo-informativo-al-pie.md), [081](DECISIONS/081-calendario-la-forma-del-mes-entradas-incluidas.md), [082](DECISIONS/082-metas-cabeza-orden-y-un-final-que-pesa-poco.md) y [083](DECISIONS/083-reservas-el-orden-que-el-dominio-ya-tenia-escrito.md)); sigue la 11, el Fondo de emergencia. El orden lo fijó Esteban y no se altera. La migración a IndexedDB **ya no es tarjeta** ([ADR 068](DECISIONS/068-perf5-sale-del-tablero-disparadores-verificables.md), fuente única). El resto de las iniciativas de esta fase (CFG, LIM, PA, PERF, MT, PE, ANL, AH, CAT, GAS, LG) cerró completo: el detalle de cada una está en [`CHANGELOG.md`](CHANGELOG.md), que es su dueño. La siguiente tarjeta se elige del índice de pendientes de [`BOARD.md`](BOARD.md) (primeras ~50 líneas).
