...
> Última actualización: 2026-07-03 (test(rwd): RWD.1, verificación de reflow real a 320px en E2E)
...
Desktop: Necesidades y Ahorro en 2 columnas compactas, Estilo de vida (card alta con los topes) en fila completa; DOM en el orden visual (que coincide con el asistente de distribución). Móvil sin cambios (1 columna). 1917/1917 unit; 123/123 E2E. SW v283 → v284.

| Archivo | Cambio |
|---|---|
| `modules/dominio/presupuesto/view.js`, `styles/components/analysis.css` | Orden de cards + grid 2 columnas. |

---

### feat(compromisos): D.12, aviso de tasa desconocida por deuda en la lista · 2026-07-03

El banner único de la card de estrategia se reemplaza por un aviso en la card de cada deuda con entidad sin tasa registrada ("⚠️ Tasa por confirmar...", `.text-warning`). El contexto ya no repite la tasa; CSS del banner viejo retirado. 1917/1917 unit; 123/123 E2E. SW v282 → v283.

| Archivo | Cambio |
|---|---|
| `modules/dominio/compromisos/views/lista.js`, `views/estrategia.js` | Aviso por deuda; banner global fuera. |
