...
> Última actualización: 2026-07-30. Última tarea cerrada: MC.16b, pagar con la tarjeta sube la deuda (segunda rebanada de MC.16).
...
| Tests E2E | 242/242 verdes en las 11 suites, corrida completa el 2026-07-30 (MC.16b). Desde el 2026-07-30 **sí es compuerta**: el hook de pre-commit exige el sello de una corrida verde cuando el diff toca runtime. |
