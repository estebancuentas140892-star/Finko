...
> Última actualización: 2026-07-03 (style(a11y): COL.1 y COL.2, contraste de warning y texto deshabilitado)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 1892/1892 verdes |
