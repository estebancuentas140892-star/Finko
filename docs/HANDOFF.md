...
> Última actualización: 2026-07-15 (feat(forms): FORM.1c Nuevo gasto fijo con el lenguaje v2, cierra la iniciativa Formularios v2, ADR 042)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 2826/2826 verdes |
| Tests E2E | 207/207 verde. Suites: `smoke` 128 tests, `estrategia-pago` 21 tests, `ahorro-inversion` 9 tests, `hub-ahorros` 8 tests, `navegacion-render` 7 tests, `registrar-destinos` 6 tests, `install-prompt` 6 tests, `a11y-forms` 6 tests, `registrar-sheet` 5 tests, `reflow-320` 4 tests, `registrar-distribucion` 3 tests. |
