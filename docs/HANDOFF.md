...
> Última actualización: 2026-07-13 (feat(analisis): ANL.2a score de salud como héroe + chip de mes, abre Análisis v2, ADR 038)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 2640/2640 verdes |
| Tests E2E | 198/198 verde. Suites: `smoke` 120 tests, `estrategia-pago` 21 tests, `ahorro-inversion` 9 tests, `hub-ahorros` 7 tests, `navegacion-render` 7 tests, `registrar-destinos` 6 tests, `install-prompt` 6 tests, `a11y-forms` 6 tests, `registrar-sheet` 5 tests, `reflow-320` 4 tests, `registrar-distribucion` 3 tests. |
