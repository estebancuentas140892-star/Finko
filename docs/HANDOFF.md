...
> Última actualización: 2026-07-13 (feat(agenda): CAL.4b grilla legible + selección índigo + empty state del mes, segunda rebanada de Calendario v2)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 2626/2626 verdes |
| Tests E2E | 196/196 verde. Suites: `smoke` 118 tests, `estrategia-pago` 21 tests, `ahorro-inversion` 9 tests, `hub-ahorros` 7 tests, `navegacion-render` 7 tests, `registrar-destinos` 6 tests, `install-prompt` 6 tests, `a11y-forms` 6 tests, `registrar-sheet` 5 tests, `reflow-320` 4 tests, `registrar-distribucion` 3 tests. |
