...
> Revisado: 2026-08-13. Última tarea cerrada: PA.1a, débito automático de compromisos.
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 4129/4129 verdes. 62 nuevos de PA.1a sobre los 4067 de CFG.2c |
| Tests E2E | 268/268 verdes, sello escrito sobre el runtime de PA.1a. **Compuerta** desde el 2026-07-30 |
...
- **En proceso:** nada. **PA.1a cerrada:** el ADR 052 queda Aceptado y de PA.1 vive **PA.1b** (crédito automático del ingreso fijo, misma hoja). **MT.6**, **PE.6**, **ANL.1**, **AH.7**, **CFG.1+CFG.2**, **CAT** y **GAS.2** completas. De LIM.1 queda **LIM.1c** (espera el ADR 044); de LG.2, **LG.2d**; de CFG.5, **CFG.5b** y **CFG.5c**. La siguiente tarjeta se elige del índice de pendientes de [`BOARD.md`](BOARD.md) (primeras ~50 líneas, no hace falta cargar el archivo completo).
