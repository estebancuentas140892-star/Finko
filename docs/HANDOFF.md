...
> Última actualización: 2026-07-07 (perf(rendimiento): PERF.7b, fold de hayResumen() en el bundle memoizado del resumen semanal)
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 2261/2261 verdes |
