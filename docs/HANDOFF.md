...
> Revisado: 2026-08-13. Última tarea cerrada: CFG.3b, panel de avisos en Inicio.
...
| Métrica | Valor |
|---|---|
| Tests unitarios + integración | 4183/4183 verdes, 15 de ellos del panel de avisos (CFG.3b) |
| Tests E2E | 269/269 verdes, sello escrito sobre el runtime de CFG.3b. **Compuerta** desde el 2026-07-30 |
...
Segunda rebanada del [ADR 066](DECISIONS/066-motor-unico-de-avisos.md). El motor de CFG.3a ya devolvía la lista; el terreno de Inicio ya estaba ocupado por tres paneles que cubren la mayoría de tipos con su lógica de siempre (sin pasar por el motor). El panel nuevo filtra a lo que hoy no tiene casa: apartado listo, día de pago, préstamo con fecha vencida. Vive en `resumen/` (mismo dominio agregador del dashboard). Copy propio, sin lenguaje de cobro en el préstamo (ADR 047). SW v528 → v529.
