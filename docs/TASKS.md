...
**App estable, 1728/1728 unit + 73/73 E2E verdes, lint limpio.** Último cambio: **MC.5e**, CTAs cruzados y copy de complementariedad con Mis cuentas (SW v241). **Con esto, la épica MC.5 (Límites de gasto como centro de control) queda completa, a-e.** Antes: MC.5d (alertas/refuerzos, SW v240), MC.5c (desglose por item, SW v239), MC.5b (resumen de grupos, SW v238), MC.5a (primer slice, SW v237). **Épica EP completa. Rediseño visual 2026 completo: las 8 fases cerradas.**
