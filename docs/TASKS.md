...
**App estable, 1707/1707 unit + 69/69 E2E verdes, lint limpio.** Último cambio: **MC.5c**, desglose por item dentro de cada grupo en Límites de gasto (SW v239). Antes: **MC.5b**, resumen read-only de los 3 grupos (SW v238); **MC.5a**, primer slice de la épica de Límites como centro de control (SW v237); renombre de secciones Dashboard → Inicio y Agenda → Calendario (SW v236). **Épica EP completa. Rediseño visual 2026 completo: las 8 fases cerradas.**
