...
**App estable, 1752/1752 unit + 76/76 E2E verdes, lint limpio.** Último cambio: **MC.7c**, el panel "Distribuir mi ingreso" muestra el desglose itemizado de Necesidades (gastos fijos + deudas) como preview de solo lectura, tercer slice de MC.7, Paso 1 del asistente (SW v244). Antes: MC.7b (aporte por objetivo en Ahorro); MC.7a (lógica del desglose); ADR 018 (diseño de MC.7). **Épica EP completa. Rediseño visual 2026 completo: las 8 fases cerradas.**
