...
**App estable, 1726/1726 unit + 71/71 E2E verdes, lint limpio.** Último cambio: **MC.5d**, alertas y refuerzos inteligentes por grupo y por item en Límites de gasto (SW v240). Antes: **MC.5c**, desglose por item dentro de cada grupo (SW v239); **MC.5b**, resumen read-only de los 3 grupos (SW v238); **MC.5a**, primer slice de la épica (SW v237). **Épica EP completa. Rediseño visual 2026 completo: las 8 fases cerradas.**
