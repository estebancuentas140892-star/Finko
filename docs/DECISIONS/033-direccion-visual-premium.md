...
**Estado:** Propuesta con estreno parcial autorizado (2026-07-12): al aprobar el handoff de Inicio v2 ([ADR 034](034-inicio-v2.md)), Esteban autorizó consumir D1 (sombra en reposo) y D2 (degradado de identidad) **acotados al dashboard de Inicio**, en línea con las recomendaciones de P1 y P5. P2, P3 y P4, y el despliegue global del sistema (rebanadas DV.2a a DV.2d, en [BOARD.md](../BOARD.md)), siguen pendientes de validación formal.
**Fecha:** 2026-07-10
