...
**Estado:** Propuesta (diseño). Escrito en la fase de análisis de **MC.13** (Opus 4.8), antes de codificar (regla 2.6). **Contiene dos decisiones que son de Esteban** (conflictos con ADRs aprobados, señalados abajo en la sección "Decisiones pendientes de Esteban"): nada de las rebanadas que dependen de ellas se inicia sin su palabra.
**Fecha:** 2026-07-14
