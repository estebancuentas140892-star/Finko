...
| **CFG.4b** | D2.2: sello del último respaldo, aviso montado en el motor del ADR 066, estado en Ajustes | pendiente |
| **CFG.4c** | D2.3: respaldo cifrado opcional con contraseña, importación transparente | pendiente |
