...
**Cambios pendientes**: dos rebanadas (INT.1g, INT.1h) en `docs/BOARD.md`. **P8** (validación de accesibilidad de un `keydown` global) sigue bloqueando INT.1h antes de codificarla.
