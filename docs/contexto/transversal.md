...
- **Estado actual**     : IV.1 (tokens `--fk-dom-*`) cerrada 2026-07-07. **IV.2a cerrada 2026-07-09**: despliegue en nav + hub-tabs + encabezados. **IV.2d cerrada 2026-07-10**: migración de `color: var(--fk-dom-X)` a `-text`. **IV.2b cerrada 2026-07-10**: franja de modales + barras/anillos de progreso por dominio (Metas, Ahorro/fondo, Apartados, Me deben, 3 factores del score de Análisis). Sigue IV.2c (calendario/inicio, ver BOARD).
- **Verificado contra** : commit de IV.2b (2026-07-10).
