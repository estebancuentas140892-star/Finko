...
**Cambios pendientes**: **MC.13** (Distribución v2), **MC.16** (tarjeta de crédito integrada, requiere ADR), **MC.17** (transferencias entre cuentas propias) y **MC.18a a MC.18e** (rediseño visual de la pantalla, ADR 035: hero con total, tarjetas con chips, GMF integrado, fuentes de ingreso agrupadas, distribuir como tarjeta de entrada; MC.18b absorbe la verificación de legibilidad de logos de la ex MC.15b) siguen pendientes en `docs/BOARD.md`, todos dentro de la iniciativa "Mis Cuentas v2".
