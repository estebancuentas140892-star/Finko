...
- **Relaciona con IN.5** (eliminar/transformar "Gasto rápido"): con TX.9 completo (formulario rápido, categoría primero, categorías personalizadas), IN.5 ya puede evaluarse sin bloqueos pendientes.
