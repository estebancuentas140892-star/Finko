# AGENTS.md - Finko Codex

> **Este archivo es el punto de entrada para Codex (y cualquier asistente IA) al abrir esta carpeta.**
...
**Escala de modelos (familia Codex 5, revisada 2026-07-02):**
...
Los archivos existentes (`HANDOFF.md`, `CHANGELOG.md`, `AGENTS.md`, etc.) tienen `-` heredados. **No es obligatorio limpiarlos de golpe**: cuando se toque un archivo `.md` por otra razón, aprovechar para reemplazar los `-` por la alternativa correcta. En texto nuevo, la regla es estricta: cero `-`.
